                        ...
                        <Formik
                            ...
                            onSubmit={(values, { setSubmitting, resetForm }) => {
                                ...
                                const filteredArray = attendanceData.filter(
                                    (item) => item.isPunchOutApproved == true
                                );
                                let options = [];
                                    ...
                                    <div>
                                        <Formik
                                            ...
                                            onSubmit={(values, { setSubmitting }) => {
                                                ...
                                                getTodayAttendancePunchOutSiteWiseList(requestData).then((response) => {
                                                    if (response.data.responseStatus === 200) {
                                                        console.log('response.data.responseStatus: ', response.data);
                                                        // setFilteredTeam(response.data.response)
                                                            ...
                                                            {attendanceData.length > 0 ? (
                                                                attendanceData.map((v, i, record) => (
                                                                    <tr style={{ backgroundColor: "D9D9D9" }} >
                                                                        ...
                                                                        <td>
                                                                            <input
                                                                                name="isPunchOutApproved"
                                                                                type="checkbox"
                                                                                checked={v.isPunchOutApproved}
                                        ...
                                        <Formik
                                            ...
                                            onSubmit={(values, { setSubmitting, resetForm }) => {
                                                ...
                                                const filteredArray = attendanceData2.filter(
                                                    (item) => item.isPunchOutApproved != false && item.isAttendanceApproved != true
                                                );
                                                let options;
                                                filteredArray.forEach((data) => {
                                                    options.push({
