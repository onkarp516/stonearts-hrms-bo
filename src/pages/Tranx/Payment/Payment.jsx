...
import { getPaymentListByCompany, get_Payment_list } from "../../../services/api_functions";
...
function Payment(props) {
  ...
  const [PaymmentData, setPaymmentData] = useState([]);
    ...
    get_Payment_list()
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          setPaymmentData(res.data);
          setPaymentList(res.data);
          //   this.setState({ PaymentList: res.data, PaymmentData: res.data });
        }
      })
      .catch((error) => {
