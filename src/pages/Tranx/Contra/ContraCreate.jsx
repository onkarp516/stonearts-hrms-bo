...
class ContraCreate extends Component {
  constructor(props) {
    super(props);
  ...
  handleTypeChange = (e) => {
    this.setState({ typeValue: e.value });
  };
  ...
  render() {
    const { isLoading, initVal, rows, cashAcbankLst, bankaccmodal } =
      this.state;
                        ...
                        <Col md="2">
                          <FormGroup>
                            ...
                            <CustomInput
                              ...
                              onChange={handleChange}
                              placeholder="Voucher No"
                              name="voucher_contra_no"
                              id="voucher_contra_no"
                      ...
                      <div>
                        <div className="row ">
                          ...
                          <div className="col-lg-1">
                            <Link to="/Dashboard/Tranx/contra">
                              <Button
...
export default WithUserPermission(ContraCreate);
