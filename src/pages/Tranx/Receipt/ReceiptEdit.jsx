...
const ReceiptEdit = () => {
  ...
  const setReceiptEditData = () => {
    // const { id } = this.state.receiptEditData;
    // console.log("receivedId", id);
    // console.log("ID", this.state.receiptEditData);
    let formData = new FormData();
    console.log("id of receipt edit", location.state.id);
    formData.append("receiptId", location.state.id);
    get_receipt_by_id(formData)
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          let { perticulars } = res;
          let initData = {
            receipt_code: res.receipt_no,
            receipt_sr_no: res.receipt_sr_no,
            pi_transaction_dt: moment(res.tranx_date).format("DD-MM-YYYY")
          }
          // initVal["receipt_no"] = res.receipt_no;
          ...
          //   cashAcbankLst,
          // } = this.state;
          // this.myRef.current.setFieldValue("receiptId", res.receiptId);
                      ...
                      <Col md="2">
                        ...
                        /> */}
                          <CustomDateInputs
                            ...
                            placeholder="pi_transaction_dt"
                            name="pi_transaction_dt"
                            dateFormat="dd/MM/yyyy"
                            value={values.pi_transaction_dt}
                            required
                          // invalid={errors.pi_transaction_dt ? true : false}
                          // onChange={handleChange}
                          // inputError={errors.pi_transaction_dt}
                          // onBlur={onBlur}
                          />
