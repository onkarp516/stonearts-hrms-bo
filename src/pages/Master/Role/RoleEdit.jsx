...
export default function Page1(props) {
  ...
  const getRolePermissionsById = (fd) => {
    console.log("location: ", location);

    let requestData = new FormData();
    requestData.append("role_id", location.state.id);
    getRolePermissionsForEdit(requestData)
      ...
      .then((response) => {
        ...
        if (response.responseStatus == 200) {
          ...
          let userPer = getUserAccessPermission(fd, data.permissions);
          setInitVal(initVal);
  ...
  return (
    <Formik
      ...
      onSubmit={(values, { setSubmitting, resetForm }) => {
        ...
        console.log("OrgSysPermission: ", userPermission);
