  ...
  return (
    <Formik
      ...
      validationSchema={Yup.object().shape({
        ...
        cType: Yup.string().trim().required("C Type is required"),
        // // Registered Address
        ...
        // // Corporate Address
        Caddress: Yup.string().trim().required("Corporate address is required"),
        Carea: Yup.string().trim().required("Corporate area is required"),
        // Cpincode: Yup.string().trim().required("Corporate pincode is required"),
        Cpincode: Yup.string()
          .required()
          .matches(/^[0-9]+$/, "Must be only digits")
          .min(6, 'Must be exactly 6 digits')
          .max(6, 'Must be exactly 6 digits'),
        Ccity: Yup.string().trim().required("Corporate city is required"),
        Cstate: Yup.string().trim().required("Corporate state is required"),
        Ccountry: Yup.string().trim().required("Corporate country is required"),
        // // License Information
        ...
        // // Admin Details
        a_fullname: Yup.string().trim().required("Full name is required"),
        ...
        a_mobile: Yup.string()
          ...
          .matches(/^[0-9]{10}$/, "Invalid admin mobile number"),

        a_username: Yup.string().trim().required("Username is required"),
      ...
      onSubmit={(values, { setSubmitting, resetForm }) => {
        ...
        requestData.append("regCityId", values.city);
        requestData.append("regStateId", values.state);
        requestData.append("regCountryId", values.country);
        ...
        requestData.append("corpCityId", values.Ccity);
        requestData.append("corpStateId", values.Cstate);
        requestData.append("corpCountryId", values.Ccountry);
        requestData.append("licenseNo", values.licenseNumber);

        requestData.append(
          "licenseExpiryDate",
          moment(values.licenseExpiry).format("YYYY-MM-DD")
        );
        requestData.append(
          "holidayFromDate",
        ...
        requestData.append("gstTypeId", values.gst_type);
        ...
        createCompany(requestData)
          .then((response) => {
            if (response.data.status === 200) {
              ...
              // setSubmitting(false);
              openModal("Error in Company Creation", "error");
            }
          })
          .catch((error) => {
            setSubmitting(false);
                  ...
                  <div className="blockcntnr">
                      ...
                      <div className="row mt-2 rowLay">
                        <div className="col-lg-4">
                          <div class="textOnInput">
                            <CustomInput
                              label="Company Code"
                              className={`form-control ${touched.companyCode && errors.companyCode
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                        ...
                        <div className="col-lg-2">
                          <div class="textOnInput">
                            <CustomSelect
                              label="Company Type"
                              className={`form-control ${touched.companyType && errors.companyType
                                  ? "is-invalid"
                                  : ""
                                }`}
                              id="companyType"
                        ...
                        <div className="col-lg-2">
                          <div class="imgInput">
                            <CustomInput
                              label="Company Logo"
                              className={`form-control ${touched.cType && errors.cType
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="file"
                      ...
                      <div className="row mt-2 rowLay">
                        <div className="col-lg-4">
                          <div class="textOnInput">
                            <CustomInput
                              label="Address"
                              className={`form-control ${touched.Caddress && errors.Caddress
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                        ...
                        <div className="col-lg-4">
                          <div class="textOnInput">
                            <CustomInput
                              label="Area"
                              className={`form-control ${touched.Carea && errors.Carea
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                        ...
                        <div className="col-lg-1">
                          <div class="textOnInput">
                            <CustomInput
                              label="Pincode"
                              className={`form-control ${touched.Cpincode && errors.Cpincode
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                        ...
                        <div className="col-lg-1">
                          <div class="textOnInput">
                            <CustomSelect
                              label="City"
                              className={`form-control ${touched.Ccity && errors.Ccity
                                  ? "is-invalid"
                                  : ""
                                }`}
                              id="Ccity"
                        ...
                        <div className="col-lg-1">
                          <div class="textOnInput">
                            <CustomSelect
                              label="State"
                              className={`form-control ${touched.Cstate && errors.Cstate
                                  ? "is-invalid"
                                  : ""
                                }`}
                              id="Cstate"
                        ...
                        <div className="col-lg-1">
                          <div class="textOnInput">
                            <CustomSelect
                              label="Country"
                              className={`form-control ${touched.Ccountry && errors.Ccountry
                                  ? "is-invalid"
                                  : ""
                                }`}
                              id="Ccountry"
                        ...
                        <div className="col-lg-3">
                          <div class="textOnInput">
                            <CustomInput
                              ...
                              className={`form-control ${touched.licenseNumber && errors.licenseNumber
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                        ...
                        <div className="col-lg-3">
                          <div class="textOnInput">
                            <CustomInput
                              ...
                              className={`form-control ${touched.licenseExpiry && errors.licenseExpiry
                                ? "is-invalid"
                                : ""
                                }`}
                              type="date"
                      ...
                      <div className="row mt-2 rowLay">
                        ...
                        <div className="col-lg-2">
                          <div class="textOnInput">
                            <CustomInput
                              label="Whats App"
                              className={`form-control ${touched.whatsApp && errors.whatsApp
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                        ...
                        <div className="col-lg-2">
                          <div class="textOnInput">
                            <CustomInput
                              label="Currency"
                              className={`form-control ${touched.currency && errors.currency
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                      ...
                      <div className="row mt-2 rowLay">
                        <div className="col-lg-3">
                          <div class="textOnInput">
                            <CustomInput
                              label="Fullname"
                              className={`form-control ${touched.a_fullname && errors.a_fullname
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                        ...
                        <div className="col-lg-3">
                          <div class="textOnInput">
                            <CustomInput
                              label="Email"
                              className={`form-control ${touched.a_email && errors.a_email
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                        ...
                        <div className="col-lg-2">
                          <div class="textOnInput">
                            <CustomInput
                              label="Mobile Number"
                              className={`form-control ${touched.a_mobile && errors.a_mobile
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                        ...
                        <div className="col-lg-2">
                          <div class="textOnInput">
                            <CustomInput
                              label="Username"
                              className={`form-control ${touched.a_username && errors.a_username
                                  ? "is-invalid"
                                  : ""
                                }`}
                              type="text"
                    ...
                    <div className="row mt-2 rowLay">
                      <CustomToggleSwitch
                        ...
                        className={`form-control ${touched.gstApplicable && errors.gstApplicable
                            ? "is-invalid"
                            : ""
                          }`}
                        id="gstApplicable"
                        ...
                        <div className="row mt-2 rowLay">
                          <div className="col-lg-3">
                            <div class="textOnInput">
                              <CustomInput
                                label="Gst Number"
                                className={`form-control ${touched.gstNumber && errors.gstNumber
                                    ? "is-invalid"
                                    : ""
                                  }`}
                                type="text"
                          ...
                          <div className="col-lg-3">
                            <div class="textOnInput">
                              <CustomSelect
                                label="Gst Type"
                                className={`form-control ${touched.gst_type && errors.gst_type
                                    ? "is-invalid"
                                    : ""
                                  }`}
                                id="gst_type"
                          ...
                          <div className="col-lg-3">
                            <div class="textOnInput">
                              <CustomInput
                                ...
                                className={`form-control ${touched.gstApplicableDate &&
                                ...
                                // value={moment(values.licenseExpiry).format(
                                //   "Do-MMM-YYYY"
                                // )}
                                onChange={handleChange}
                                onBlur={handleBlur}
                    ...
                    <div>
                      <div className="row mt-2 rowLay">
                        ...
                        <CustomToggleSwitch
                          label="PF Registered"
                          className={`form-control ${touched.isCompanyPf && errors.isCompanyPf
                              ? "is-invalid"
                              : ""
                            }`}
                          id="isCompanyPf"
                        ...
                        {OptionsSystemConf.map((item, key) => {
                          ...
                          return (
                            <CustomToggleSwitch
                              ...
                              className={`form-control ${touched[fieldName] && errors[fieldName]
                                  ? "is-invalid"
                                  : ""
                                }`}
                              name={fieldName}
