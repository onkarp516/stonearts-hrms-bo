  ...
  return (
    <Formik
      ...
      onSubmit={(values, { setSubmitting, resetForm }) => {
        ...
        requestData.append("userRole", values.role_id);
        requestData.append("companyId", CompanyList[0].value);
        requestData.append("branchId", values.branch_id);
            ...
            >
              ...
              >
                ...
                >
                    ...
                    <div className="col-lg-4">
                      <div class="textOnInput">
                        <CustomSelect
                          ...
                          className={`form-control ${
                            touched.comapny && errors.comapny
                              ? "is-invalid"
                              : ""
                          }`}
                          id="comapny"
                          ...
                          value={`1`}
                          onChange={(e) => {
                            console.log("comapny selection : ", e.target.value);
                            // console.log("v: ", v);
                            let value = e.target.value;
                            if (value != null) {
                              setFieldValue("comapny", value);
                              setFieldValue("comapny_id", value);
                              // listSysPermission(value);
                              // this.setState({ opBranchList: [] });
                              // this.listGetBranch(v);
                            } else {
                              setFieldValue("comapny", "");
                            }
                          }}
                          onBlur={handleBlur}
                        />
                  ...
                  <div style={{ overflowX: "hidden", overflowY: "scroll", height: "538px", marginTop: "20px", scrollbarWidth: "none", msOverflowStyle: "none" }}>
